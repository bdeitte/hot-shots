...
class Telemetry {
   ...
   * opposed to a writer/transport error. There is no separate
   * bytesDroppedQueue counter in the telemetry schema, so this increments the
   * overall bytesDropped/packetsDropped totals plus packetsDroppedQueue.
   * @param {number} bytes - Number of bytes dropped
   */
