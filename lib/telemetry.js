...
class Telemetry {
  ...
  /**
   * Record bytes dropped due to a full client-side queue (backpressure), as
   * opposed to a writer/transport error. Increments the overall
   * bytesDropped/packetsDropped totals plus the queue-specific pair, mirroring
   * how recordBytesDroppedWriter splits out the writer pair.
   * @param {number} bytes - Number of bytes dropped
   */
