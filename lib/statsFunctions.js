...
function applyStatsFns (Client) {
  ...
  Client.prototype.increment = function (stat, value, sampleRate, tags, callback) {
    ...
    debug('increment: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.histogram = function (stat, value, sampleRate, tags, callback) {
    debug('histogram: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.distribution = function (stat, value, sampleRate, tags, callback) {
    debug('distribution: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.gauge = function (stat, value, sampleRate, tags, callback) {
    debug('gauge: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
   ...
   */
    Client.prototype.gaugeDelta = function (stat, value, sampleRate, tags, callback) {
      const sign = value >= 0 ? '+' : '-';
      debug('gaugeDelta: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.unique = Client.prototype.set = function (stat, value, sampleRate, tags, callback) {
    debug('unique/set: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
