...
// (closingFlushInterval * 11, ~550ms) on purpose: a first-ever DNS lookup or a
// TCP connect taking a few hundred ms is ordinary and must not lose the flush,
// so this only bounds a genuinely stuck transport.
