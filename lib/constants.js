...
// Codes for sends the DNS layer refused outright, without handing anything to
// the socket. Client.close() lets a final flush that fails with one of these
// through instead of aborting the close, since there is nothing left to wait on
// and the socket still needs closing. Any code added here must mean "refused,
// nothing written" - a genuine write or resolution failure does not belong.
exports.DNS_REFUSED_CODES = [
