...
// the ONLY meaning of this code - close() matches on it (in its final-flush
// error branch) to report the cancelled flush without aborting the socket
// close, so it must stay scoped to genuine cancellation. A send that merely
// arrives after the client is already closed is a different case: see
// DNS_CLOSED_CODE below.
