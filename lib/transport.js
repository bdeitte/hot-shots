...
const createUdsTransport = args => {
  ...
  const maxRetries = args.udsRetries !== undefined ? args.udsRetries : 3;
  const initialDelay = args.udsRetryDelay !== undefined ? args.udsRetryDelay : 100;
  const maxDelay = args.udsMaxRetryDelay !== undefined ? args.udsMaxRetryDelay : 1000;
  const backoffFactor = args.udsBackoffFactor !== undefined ? args.udsBackoffFactor : 2;
