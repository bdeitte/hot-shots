...
const { DNS_MAX_PENDING, DNS_QUEUE_FULL_CODE, PROTOCOL } = require('./constants');
...
const createUdpTransport = args => {
  ...
  return {
    ...
    // on an in-flight cacheDns lookup. Not part of the public Transport
    // interface, and always 0 when cacheDns is off or nothing is queued.
