...
const createUdsTransport = args => {
  ...
  const initialDelayMs = udsOpts.retryDelayMs !== undefined ? udsOpts.retryDelayMs : 100;
  const maxDelayMs = udsOpts.maxRetryDelayMs !== undefined ? udsOpts.maxRetryDelayMs : 1000;
